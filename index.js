...
*/
const XNZUL = '⚡⌁XNZUL BOT⌁⚡'; // JANGAN UBAH-UBAH INFO!!!
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾XNZUL BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/r00t_xnzul' ,MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾XNZUL BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/r00t_xnzul' ,MessageType.text);
}
